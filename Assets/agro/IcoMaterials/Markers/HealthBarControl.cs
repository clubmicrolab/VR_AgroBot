...
public class HealthBarControl : MonoBehaviour
{
    ...
    [SerializeField]
    private Material[] materialeSanatate; 

    [SerializeField]
    private Renderer rendererBaraSanatate; 

    private int indexMaterialCurent = 0; 
    private int indexMaterialMaxim;
    private bool atingereObiectTinta = false;

    private float timpSchimbareMaterial = 50.0f; 
    private float timpCurentSchimbare = 0.0f;
    private bool schimbareInProgres = false;

    void Start()
    {
        indexMaterialMaxim = materialeSanatate.Length - 1;
        if (rendererBaraSanatate != null)
        {
            rendererBaraSanatate.material = materialeSanatate[indexMaterialCurent];
        }
    }
